...
class Bundle
{
    ...
    public function renderCss()
    {
        ...
        if (strpos(Yii::getAlias('@web'), 'backend') !== false) {  
            $bundleUrl = SITE_URL.Yii::$app->homeUrl.'themes/metronic'.$this->getCssBundleUrl();
        }else{
            $bundleUrl = SITE_URL.Yii::$app->homeUrl.'themes/custom'.$this->getCssBundleUrl();
        }
    ...
    public function renderJs()
    {
        ...
        if (strpos(Yii::getAlias('@web'), 'backend') !== false) {        
            $bundleUrl = SITE_URL.Yii::$app->homeUrl.'themes/metronic'.$this->getJsBundleUrl();
        }else{
            $bundleUrl = SITE_URL.Yii::$app->homeUrl.'themes/custom'.$this->getJsBundleUrl();
        }

...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td style="font-family:Arial, Geneva, sans-serif; font-size:14px; color:#45482f; line-height:20px">
      ...
      <p>Hi <?php echo $projectData[0]['fname'].' '.$projectData[0]['lname']; ?>,</p>
      <?php if($approve==1) { ?>
      <p>The project <strong><?php echo $projectData[0]['project_title'] ?></strong> has been approved by admin.</p>
      <p>Now the EquiPPP users can view the project in the EquiPPP portal.</p>
      <?php } else if($approve==6) { ?>
      <p>The project <strong><?php echo $projectData[0]['project_title'] ?></strong> has been de-activated by admin.</p>
      <?php } else if($approve==2) { ?>
      <p>The project <strong><?php echo $projectData[0]['project_title'] ?></strong> has been completed.</p>
      <?php } ?>
      <p>Thank You, <br />

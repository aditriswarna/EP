...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td style="font-family:Arial, Geneva, sans-serif; font-size:14px; color:#45482f; line-height:20px">
      ...
      <p>Hi,</p>
      <p>Thank you for registering with EquiPPP. Please click the below link to verify your account.</p>
      <p><a href="<?php echo SITE_URL. yii::getAlias('@web').'/site/email-verification?authkey='.$userdata->auth_key; ?>">click here</a></p>
      <p>Thank You, <br />

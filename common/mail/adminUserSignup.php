...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td style="font-family:Arial, Geneva, sans-serif; font-size:14px; color:#45482f; line-height:20px">
        ...
        <p>Hi &nbsp;<?php $user->username; ?>,</p>
        <p>You are an active admin user on EquiPPP portal. You can login into EquiPPP portal with below credentials.</p>
        <p>Login Credentials</p>
        <p>Username: &nbsp;<?php echo $user->username;?></p>
        <p>Password: &nbsp;<?php echo $randomPwd;?></p>
        <p>Thank You, <br />

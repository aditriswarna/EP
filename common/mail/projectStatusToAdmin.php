...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td style="font-family:Arial, Geneva, sans-serif; font-size:14px; color:#45482f; line-height:20px">
      <p>Hi Admin,</p>
      <?php if($approve==1) { ?>
      <p>You have approved the project <strong><?php echo $projectData[0]['project_title'] ?></strong>.</p>
      <?php } else if($approve==6) { ?>
      <p>You have rejected the project <strong><?php echo $projectData[0]['project_title'] ?></strong>.</p>
      <?php } else if($approve==2) { ?>
      <p>The project <strong><?php echo $projectData[0]['project_title'] ?></strong> is completed.</p>
      <?php } ?>
      <p>Thank You, <br />

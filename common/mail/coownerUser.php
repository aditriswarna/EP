...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td style="font-family:Arial, Geneva, sans-serif; font-size:14px; color:#45482f; line-height:20px">
      ...
      <p>You are added as co-owner to the EquiPPP project <strong><?php echo $projectdata[0]['project_title']; ?></strong> by <strong><?php echo $coowner[0]['fname'].' '.$coowner[0]['lname']; ?></strong>.</p>
      <p><a href="<?php echo SITE_URL.'equippp/backend/web/project-co-owners/coowner-to-user?cpk='.base64_encode($coownerpk).'&is_coowner='.base64_encode(1).'&pname='.base64_encode($projectdata[0]['project_title']); ?>" class="agree" style="background: #52b6b8;color: #fff; padding: 10px 15px; text-decoration: none; font-family: sans-serif; font-size: 13px; font-weight: bold; text-transform: uppercase;margin: 5px; display: inline-block;">Agree</a></br><a href="<?php echo SITE_URL.'equippp/backend/web/project-co-owners/coowner-to-user?cpk='.base64_encode($coownerpk).'&is_coowner='.base64_encode(0).'&pname='.base64_encode($projectdata[0]['project_title']); ?>" class="disagree" style="background: #d85c6f;color: #fff; padding: 10px 15px; text-decoration: none; font-family: sans-serif; font-size: 13px; font-weight: bold; text-transform: uppercase;margin: 5px; display: inline-block;">Disagree</a></p>
      <p>Thank You, <br />

...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td style="font-family:Arial, Geneva, sans-serif; font-size:14px; color:#45482f; line-height:20px">
      ...
      <p>The project <strong><?php echo $project_name ?></strong> has been created successfully.</p>
      <p>Admin Approval is still pending. The project is displayed on EquiPPP portal once the admin approves.</p>
      <p>Thank You, <br />

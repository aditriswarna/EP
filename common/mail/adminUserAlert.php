...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" > 
     <tr> <td height="35"   style="font-family:Arial, Helvetica, sans-serif; font-size:16px; font-weight:bold; color:#73A90B;">Registration Alert</td></tr>
     </table>
    ...
    <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" style="border:#dddede solid 1px" >
	 ...
	 <tr>
	   ...
	   <td style='font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#45482f; background:#FFFFFF; padding:8px; border-bottom:#dddede solid 1px; border-left:#dddede solid 1px;'><?php echo $userdata->email ?> </td>
	   </tr>
	 <tr>
	   <td style='font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; color:#45482f; background:#FFFFFF; padding:8px; border-bottom:#dddede solid 1px'>User Type</td>
	   <td style='font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#45482f; background:#FFFFFF; padding:8px; border-bottom:#dddede solid 1px; border-left:#dddede solid 1px;'><?php echo $usertype->user_type ?> </td>
	   </tr>

...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td style="font-family:Arial, Geneva, sans-serif; font-size:14px; color:#45482f; line-height:20px">
      ...
      <p>Hi <?php echo @$userprofile[0]['fname'].' '.@$userprofile[0]['lname'] ?>,</p>
      <p>You just requested a password change.</p>
       <p>New Password: &nbsp;<?php echo $randomPwd;?></p>
      <p>Login with the above password and reset your password after login.</p>
      <p>Thank You, <br />

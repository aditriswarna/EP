...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td style="font-family:Arial, Geneva, sans-serif; font-size:14px; color:#45482f; line-height:20px">
      ...
      <p>Hi Admin,</p>
      <p><strong><?php echo $coowner[0]['fname'].' '.$coowner[0]['lname']; ?></strong> is added as co-owner to the project <strong><?php echo $projectdata[0]['project_title']; ?></strong> by <strong><?php echo $userdata[0]['fname'].' '.$userdata[0]['lname']; ?></strong>.</p>
      </td>
  </tr>
</table>
    <br /></td>

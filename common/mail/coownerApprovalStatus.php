...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <?php if($is_coowner == 1) { ?>
    <p><strong><?php echo $userDetails[0]['fname'].' '.$userDetails[0]['lname']; ?></strong> has accepted to become a co-owner for the project <strong><?php echo $projectdata[0]['project_title']; ?></strong>.</p>
    <?php } else { ?>
    <p><strong><?php echo $userDetails[0]['fname'].' '.$userDetails[0]['lname']; ?></strong> has declined to become a co-owner for the project <strong><?php echo $projectdata[0]['project_title']; ?></strong>.</p>
    <?php } ?>
      <p>Thank You, <br />

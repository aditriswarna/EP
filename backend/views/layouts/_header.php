...
<!-- BEGIN HEADER -->
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                <!-- BEGIN LOGO -->
                <div class="page-logo">
					<a href="<?php echo Yii::$app->homeUrl;?>" class="logo-default title-logo">
						<img src="<?= $imagePath;?>/themes/custom/images/Equippp-logo.png" alt="EquiPPP"></a>
					<div class="menu-toggler sidebar-toggler"> </div>
                </div>
                <!-- END LOGO -->
                <!-- BEGIN RESPONSIVE MENU TOGGLER -->
                <a href="javascript:;" class="menu-toggler responsive-toggler" data-tog gle="collapse" data-target=".navbar-collapse"> </a>
                ...
                <div class="top-menu">
                   ...
                   <!--   <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                        ...
                        <!-- DOC: Apply "dropdown-dark" class after below "dropdown-extended" to change the dropdown styte -->
                        <li class="dropdown dropdown-user drpdwn">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <?php $sql = 'select user_image from user_profile where user_ref_id='. Yii::$app->user->identity->id;
                                ...
                                if(!empty($image[0]['user_image']) && isset($file['@metadata']['effectiveUri'])) { ?>
                                                                        
                                    <img alt="" class="img-circle" src="<?php echo $file['@metadata']['effectiveUri']; ?>" />
                                    
                                <?php } else { ?>                                    
                                    <img alt="" class="img-circle" src="<?php echo SITE_URL.$imagePath; ?>/images/avatar.png" />

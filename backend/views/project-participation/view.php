...
<div class="project-participation-view">
    ...
    <h1 class="box-title"><?php echo Html::encode($model['project_title']) ?></h1>
    ...
    <?php echo DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                ...
                'value' => !empty($model['investment_type'])?$model['investment_type']:'Not Assigned'
            ],
            [
                'attribute'=>'equity_type',
                'label'=>'Equity Type',
                'value' => !empty($model['equity_type'])?$model['equity_type']:'Not Assigned'
            ],
            [
                'attribute'=>'amount',
                'label'=>'Amount',
                'value' => !empty($model['amount'])?$model['amount']:'Not Assigned'
            ],
            [
                'attribute'=>'interest_rate',
                'label'=>'Interest Rate',
                'value' => !empty($model['interest_rate'])?$model['interest_rate']:'Not Assigned'
            ],
            'created_date',
        ],
    ]) ?>

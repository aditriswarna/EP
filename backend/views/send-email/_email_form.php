...
?>
<style>
    .fancybox-skin{ margin:0 auto; padding:0 !important; width: 430px !important; background:#fff;}
    ...
    .fancybox-skin .fancybox-close{ background:url(<?php echo Yii::$app->urlManagerFrontend->baseUrl;?>/../themes/custom/css/closeimage.jpg) 0 0 no-repeat;top: 14px; right: 10px;}

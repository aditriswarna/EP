...
.tg-border{ border:1px solid #ccc }
    ...
    @media(max-width: 991px) {
		...
		.mp-cmtbox1{clear:both;display:inline-block;overflow:hidden;}
    }
...
<div class="dashboard-page">
    <div class="clearfix">
        <h3 class="page-title pull-left"> Dashboard & Statistics
           <!-- <small>dashboard & statistics</small> -->
        </h3>

        <ul class="notice-mailbox pull-right"><li>
                <div class='dropdown '>
                ...
                <div class='dropdown'>
                    ...
                    <?php if ($project_likes_notif > 0 || $project_comment_notif > 0) {
                        ...
                        <div class="dropdown-menu nitif-dropdown">
                            <div class="external-views">
                            <div class="msg-info"><h3>You have <span class="bold" id="notification_msg_count"><?php echo ($project_likes_notif + $project_comment_notif); ?> </span> New Messages</h3></div><div class="views-info"><!--<a href="<?php echo Url::to(['/communique/inbox-mails']); ?>">view all</a>--></div>
                            </div>
                    ...
                    <?php
                        ...
                        <div class="dropdown-menu nitif-dropdown">
                            <div class="external-views">
                            <div class="msg-info"><h3>You have <span class="bold">0  New</span> Messages</h3></div><div class="views-info"><!--<a href="<?php echo Url::to(['site/index']); ?>">view all</a>--></div>
                            </div>
                            <div class="scroller" style="height: 300px;" data-always-visible="1" data-rail-visible="0">
...
<!--                            <li>
                                <div class="col1">
                                    <div class="cont">
                                        <div class="cont-col1">
                                            <div class="label label-sm label-success"><i class="fa fa-user-md"></i></div>
                                        </div>
                                        <div class="cont-col2">
                                        ...
                                        <div class="cont">
                                            ...
                                            <div class="cont-col2">
                                                <div class="desc">
                                                    ...
                                                    elseif (empty($project_recent_activitie['comments']) && !is_numeric($project_recent_activitie['status']) && !empty($project_recent_activitie['project_title']))
                                                        echo 'You received an email about <b>' . $project_recent_activitie['project_title'] . '</b> project';
                                                    elseif (empty($project_recent_activitie['comments']) && !is_numeric($project_recent_activitie['status']) && empty($project_recent_activitie['project_title']))
                                                        echo 'You have received an email about your EquiPPP account';
                                                    else
                    ...
                    <div class="scroller" style="height: 350px;" data-always-visible="1" data-rail-visible="0">
                        <div id="calendar">
                            <div style="width: 100%">
                                ...
                                <!-- Zabuto Calendar -->
                                <script src="<?php echo Yii::getAlias('@web') ?>/js/zabuto_calendar.min.js"></script>
                                <link rel="stylesheet" type="text/css" href="<?php echo Yii::getAlias('@web') ?>/css/zabuto_calendar.min.css">
...
//                                    });
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <span class="title-1 events-titles">Projects List</span>
                                            </div>
                                            <div class="modal-body divProjectsList event-popup" style="padding: 0px 10px; height: 400px; overflow: auto;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="mt-comment commet-info" id="divComment_<?php echo $comment['project_comment_id'] ?>">
                                            ...
                                            <div class="mt-comment-body">
                                                ...
                                                <div class="mt-comment-details">
                                                    <span class="mt-comment-status mt-comment-status-pending"><?php echo strtoupper($comment['status_name']); ?></span>
                                                    <ul class="mt-comment-actions">
                                                        ...
                                                        <li>
                                                            <a href="#" id="btnView_<?php echo $comment['project_comment_id'] ?>" data-target="#viewComment" onclick="javascript: viewComment1('<?php echo $userImageUrl; ?>', '<?php echo $comment['project_title']; ?>', '<?php echo $comment['created_date']; ?>', '<?php echo $comment["comments"]; ?>', '<?php echo $comment['status_name']; ?>')" data-toggle="modal">View</a>
                                                        </li>
                                                        <li>
                                        ...
                                        <div class="modal-dialog" style="width:300px;">
                                            ...
                                            <div class="modal-content" style="width:300px; margin:0px auto">
                                                ...
                                                <div class="modal-body divCommentsDesc divCommentsDesc-comment" style="display: inline-block;">
                                                    <button style="float: right;margin-top:4px;" type="button" class="close update-close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                    <div class="title-1" id="project_title"></div>
                                                    <div class="userImg"  style="    margin-left:0px;" id="divUserImage"><img id="userImage" src="" /></div>
                                                    <div class="userComment" style="    padding-left: 10px;" id="project_comments"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="row grap-admin">

        <script src="<?php echo Yii::$app->request->baseUrl ?>/js/charts/highcharts.js"></script>
        <script src="<?php echo Yii::$app->request->baseUrl ?>/js/charts/data.js"></script>
        <script src="<?php echo Yii::$app->request->baseUrl ?>/js/charts/drilldown.js"></script>
        ...
        <div class="col-md-6 col-sm-6">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-equalizer font-yellow"></i>
                        <span class="caption-subject font-yellow bold uppercase">Financial status of my projects</span>
                    </div>
                        ...
                        <div id="customLegend13">
                            <div class="drp3">
                                <div class="btn-group finance-rang">
                                    ...
                                    <ul class="dropdown-menu pull-right finance-dropdwon mth12 tg-border">
                                        <?php for ($i = 0; $i < 6; $i++) { ?>
                        ...
                        <div id="customLegend12">
                            <div class="drp2">
                                <div class="btn-group finance-rang">
                                    ...
                                    <ul class="dropdown-menu pull-right finance-dropdwon mth11 tg-border">
                                        <?php for ($i = 0; $i < 6; $i++) { ?>
                                            <li class="listmth11" iindex11="<?php echo $i; ?>"><a href="javascript:;" class="monthoption1" iindex11="<?php echo $i; ?>" id="fmonth" dropdwn1="2" month11="<?php echo date('m', strtotime("-$i month")); ?>" selectedmonth11="<?php echo date('M', strtotime("-$i month")); ?>" selectedyear11="<?php echo date('Y', strtotime("-$i month")); ?>"><span class="label label-sm ">  </span><?php echo date('M', strtotime("-$i month")).' - '.date('Y', strtotime("-$i month")); ?></a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div id="customLegend11">
                            <div class="actions">
                                <div class="btn-group finance-rang">
                                    ...
                                    <div class="scroller tg-border" style="height:200px; padding:0; ">
                        ...
                        <div id="customLegend23">
                            <div class="drp3">
                                <div class="btn-group finance-rang">
                                    ...
                                    <ul class="dropdown-menu pull-right finance-dropdwon mth22 tg-border">
										<?php for ($i = 0; $i < 6; $i++) { ?>
                        ...
                        <div id="customLegend22">
                            <div class="drp2">
                                <div class="btn-group finance-rang">
                                    ...
                                    <ul class="dropdown-menu pull-right finance-dropdwon mth21 tg-border">
										<?php for ($i = 0; $i < 6; $i++) { ?>
                        ...
                        <div id="customLegend21">
                            <div class="actions">
                                <div class="btn-group finance-rang">
                                    ...
                                    <div class="dropdown-menu pull-right ">
                                    <div class="scroller tg-border" style="height:200px; width:250px; padding:0;">
    ...
    <script language="javascript">
        ...
        function viewComment1(userImageUrl, project_title, created_date, comments1, status_name) {
...
*/
        ...
        function modifyComment(projectCommentId) {               
            ...
            //$('#btnEdit_'+projectCommentId).addClass('editComment');
        ...
        $(function()
        {
            ...
            {
                if ($('.loaded').length == "0" && $('.nitification_no_msg').length == 0)
                {

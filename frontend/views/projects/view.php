...
<style>
    .fancybox-opened {
        width: 850px !important; left:0 !important; right:0 !important; margin:0 auto !important;
    }
    @media only screen and (max-width: 991px) {
       .fancybox-opened {width: 94% !important; left:0 !important; right:0 !important; margin:0 auto !important; } 
       
    }
	@media only screen and (max-width: 670px) {
	 .fancybox-opened {width: 89% !important; left:0 !important; right:0 !important; margin:0 auto !important; } 
...
<div class="project-detail-pane ">
    <div class="project-detail-black-pane col-sm-5 col-xs-12">
                        ...
                        <div class="carousel-inner max-height-330" role="listbox">
                            ...
                            foreach ($project_image as $projets) {
                                ...
                                if (!empty($projets['document_name']))
                                   ...
                                   /* $key = '/uploads/project_images/' . $projets['project_ref_id'];
                                    $s3 = new Storage(); 
                                    $res = $s3->checkKeyExists(Yii::getAlias('@bucket'), $key, $projets['document_name']);
                                    print_r($res); */
        ...
        <?php
           // if($actionId != 'view') {
        ?>
           <!-- <div class="participate-area" onClick="participateProject(<?php // echo $projectData['project_id'];  ?>)"><a href="#">Express Your Interest</a></div> -->
    ...
    <div class="pop-tabs col-sm-7 col-xs-12 project-popup-view">
        ...
        <div class="tabbable-line">
            <ul class="nav nav-tabs gmap-tabs">
                ...
                <?php if (Yii::$app->user->id) { ?>
                    ...
                    <?php if ($projectData['user_ref_id'] == Yii::$app->user->id) { ?>
                        <li><a data-toggle="tab" href="#Investors"  class="getinvester">Investors List</a></li>
                    <?php } ?>
                <?php } ?>
            </ul>
            ...
            <div class="tab-content" style="padding: 0px !important;">
                <div id="Description" class="tab-pane fade in active tab-view-mar-btm10 tabHeight">
                    <?php echo Html::decode($projectData['project_desc']); ?>
                </div>
                ...
                <div id="Comments" class="tab-pane fade">
                    <div class="row comment-rowtab" style="background-color: #FFFFFF;">
                        <div class="divCommentsBlock">
                          ...
                          {
                            ?>
                            <div class="col-md-12 submit-comments mp-cmtbox" style="padding: 2px 4px 2px 4px;">
                                <div class="cmt-box">
                                    <textarea style="width: 77%" rows="2" placeholder="Comments" id="txtComments" name="txtComments"></textarea>
                                    <input type="button" name="btnAddComments" id="btnAddComments" value="Send" disabled="disabled" class="btn btn-success cmt-btnsent" />
                                </div>
                            </div>
                            <?php } ?>
        ...
        <div class="social-share-icons">
            ...
            <div class="mail-shar" onClick="emailSharing(<?php echo $projectData['project_id']; ?>, <?php echo $projectData['project_category_ref_id']; ?>, '<?php echo Yii::$app->getUrlManager()->getBaseUrl() . '/site/dynamic-new?id=' . $projectData['project_id'] . '&cat=' . $projectData['project_category_ref_id']; ?>')">
...
<input type="hidden" name="tweetText" id="tweetText" value="<?php echo SITE_URL . Yii::getAlias('@web'); ?>/site/dynamic-new?id=<?php echo $projectData["project_id"]; ?>"/>
...
<script>
    ...
    function changeCommentStatus(projectCommentId, projectId, userId, status) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#commentStatus_' + projectCommentId).html('<div class="btn-primary" style="width: 30%;text-align: center;text-align: center;float: right;"><b>' + statusName + '</b></div>');
                return false;
                //}
            },
            error: function (xhr, status, error) {
    ...
    $(function ()
    {
        ...
        var total_header = header_top + 58;

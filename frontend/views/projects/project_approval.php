...
$this->title = 'Private Project Approval Requests';
...
echo "<div class='participation-border fl-left dis-blc'>";
?> 
        ...
        ['class' => 'yii\grid\ActionColumn',
                ...
                'approve'=>function($url, $model) {
                    if ($model['is_approved'] == 1) {
                        return HTML::a('<span class="glyphicon glyphicon-ok-sign"></span>',$url,[
                            ...
                            'data-confirm'=>'Are you sure you want to remove this project from approved list?',
                            ]);
                    }else{
                        return HTML::a('<span class="glyphicon glyphicon-remove-sign"></span>',$url,[
                            ...
                            'delete-url' => $url, 
                            'pjax-container' => 'pjax-list',
                            'data-confirm'=>'Are you sure you want to approve this project?',
                            ]);
                    }                    
                },                  
              ],
            'urlCreator' => function ($action, $model, $key, $index) {
                if ($action === 'approve') {
                    ...
                    return Url::toRoute([$action, 'id' => $model['project_ref_id']]);
                } 
            } 
        ],
    ],

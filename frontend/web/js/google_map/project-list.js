(function($) {
    ...
    */
    ...
    storeLocator.Panel.NO_STORES_HTML_ = '\x3cli class\x3d"no-stores"\x3eThere are no Projects in this area.\x3c/li\x3e';
    storeLocator.Panel.NO_STORES_IN_VIEW_HTML_ = '\x3cli class\x3d"no-stores"\x3eThere are no Projects in this area.\x3cspan\x3e However, Projects closest to you are listed below.\x3c/span\x3e\x3c/li\x3e';
    storeLocator.Panel.prototype.stores_changed = function() {
        if (this.get("stores")) {
            ...
            for (var b = function() {
                ...
                }, e = 0, f = Math.min(1000, c.length); e < f; e++) {
    ...
    storeLocator.Panel.prototype.selectedStore_changed = function() {
        ...
        if (b) {
            ...
            if($('.store').hasClass('highlighted')){
				//alert($().html());
				 $('.all-projects-list').stop().animate({
                    scrollTop: $("#store-" + b.getId()).offset().top-200}, 'slow');
    ...
    */
    ...
    storeLocator.Store.prototype.getInfoWindowContent = function() {
        if (!this.content_) {
            ...
            a.push(this.generateFieldsHTML_(["image","title","location", "address", "misc", "web"]));

...
(function ($, window, document, undefined) {
	...
	var defaults = {
		...
		'markerDim'                : null,
		'catMarkers'               : {
				'1' : ['frontend/web/js/google_map_new/icons/1.png',40,40],
			         '2' : ['frontend/web/js/google_map_new/icons/2.png',40,40],
                                 '3': ['frontend/web/js/google_map_new/icons/3.png',40,40],
                                  '4': ['frontend/web/js/google_map_new/icons/4.png',40,40],
                                   '5': ['frontend/web/js/google_map_new/icons/5.png',40,40],
                                    '6': ['frontend/web/js/google_map_new/icons/6.png',40,40],
                                     '7': ['frontend/web/js/google_map_new/icons/7.png',40,40],
                                      '8': ['frontend/web/js/google_map_new/icons/8.png',40,40],
                                      '9': ['frontend/web/js/google_map_new/icons/9.png',40,40],
                                       '10': ['frontend/web/js/google_map_new/icons/10.png',40,40],
                                        '11': ['frontend/web/js/google_map_new/icons/11.png',40,40]
		...
		'distanceAlert'            : -1,
		'dataType'                 : 'json',
		'dataLocation'             : getsite_url()+'/site/mapdata',
		'dataRaw'                  : null,
		'xmlElement'               : 'marker',
		'listColor1'               : '#ffffff',
		'listColor2'               : '#eeeeee',
		...
		'dragSearch'               : false,
		'infowindowTemplatePath'   : 'frontend/web/js/google_map_new/js/plugins/storeLocator/templates/infowindow-description.html',
		'listTemplatePath'         : 'frontend/web/js/google_map_new/js/plugins/storeLocator/templates/location-list-description.html',
		'KMLinfowindowTemplatePath': 'frontend/web/js/google_map_new/js/plugins/storeLocator/templates/kml-infowindow-description.html',
		'KMLlistTemplatePath'      : 'frontend/web/js/google_map_new/js/plugins/storeLocator/templates/kml-location-list-description.html',
		'listTemplateID'           : null,
		...
		'noResultsDesc'            : 'No Projects were found for Selected Criteria. Please Change Select Criteria',
		'nextPage'                 : 'Next &raquo;',
		'prevPage'                 : '&laquo; Prev'
	};
	...
	$.extend(Plugin.prototype, {
		...
		emptyResult: function() {
			...
			// Create the map
			 map = new google.maps.Map(document.getElementById(this.settings.mapID), myOptions);
                      //  map.panBy(180,0)
			// Callback
			...
			if (originalZoom) {
				//map.setZoom(originalZoom);  commented if no record find zoom to particular location
                                map.setZoom(6)
			}
		},
